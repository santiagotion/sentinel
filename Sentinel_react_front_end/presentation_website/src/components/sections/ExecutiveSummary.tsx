...
export function ExecutiveSummary() {
  return (
    <section id="executive-summary" className="py-24 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        {/* Comparison */}
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-8 mb-12 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 p-4 border border-red-200 dark:border-red-700 rounded-xl bg-red-50 dark:bg-red-900/20 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Détection: Très tardive</span>
                </div>
                <div className="flex items-center space-x-4 p-4 border border-red-200 dark:border-red-700 rounded-xl bg-red-50 dark:bg-red-900/20 hover:shadow-lg transition-shadow duration-300">
                  <div className="w-10 h-10 bg-gradient-to-r from-red-600 to-red-700 rounded-xl flex items-center justify-center">
                    <Users className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-300">Équipe: Surveillance manuelle</span>
                </div>
                <div className="flex items-center space-x-4 p-4 border border-red-200 dark:border-red-700 rounded-xl bg-red-50 dark:bg-red-900/20 hover:shadow-lg transition-shadow duration-300">
                  <div className="w-10 h-10 bg-gradient-to-r from-red-600 to-red-700 rounded-xl flex items-center justify-center">
                    <DollarSign className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-300">Coût: Crises non prévenues</span>
                </div>
                <div className="flex items-center space-x-4 p-4 border border-red-200 dark:border-red-700 rounded-xl bg-red-50 dark:bg-red-900/20 hover:shadow-lg transition-shadow duration-300">
                  <div className="w-10 h-10 bg-gradient-to-r from-red-600 to-red-700 rounded-xl flex items-center justify-center">
                    <Shield className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-300">Réaction: Après propagation</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 p-4 border border-emerald-200 dark:border-emerald-700 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Détection: Temps réel</span>
                </div>
                <div className="flex items-center space-x-4 p-4 border border-emerald-200 dark:border-emerald-700 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 hover:shadow-lg transition-shadow duration-300">
                  <div className="w-10 h-10 bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-xl flex items-center justify-center">
                    <Users className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-300">Équipe: IA + Analystes experts</span>
                </div>
                <div className="flex items-center space-x-4 p-4 border border-emerald-200 dark:border-emerald-700 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 hover:shadow-lg transition-shadow duration-300">
                  <div className="w-10 h-10 bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-xl flex items-center justify-center">
                    <DollarSign className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-300">Coût: Investissement rentabilisé</span>
                </div>
                <div className="flex items-center space-x-4 p-4 border border-emerald-200 dark:border-emerald-700 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 hover:shadow-lg transition-shadow duration-300">
                  <div className="w-10 h-10 bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-xl flex items-center justify-center">
                    <Shield className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-300">Prévention: Avant propagation</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Recommendations */}
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 border border-gray-200 dark:border-gray-700 rounded-xl hover:shadow-lg transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-700 group">
              ...
              <h4 className="font-medium text-gray-900 dark:text-white mb-3">Déploiement Immédiat</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                Mise en œuvre progressive pour protéger l'espace informationnel national
              </p>
            </div>
            
            <div className="text-center p-6 border border-gray-200 dark:border-gray-700 rounded-xl hover:shadow-lg transition-all duration-300 hover:border-emerald-300 dark:hover:border-emerald-700 group">
              ...
              <h4 className="font-medium text-gray-900 dark:text-white mb-3">Formation Équipes</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                Formation d'équipes spécialisées pour une couverture nationale
              </p>
            </div>
            
            <div className="text-center p-6 border border-gray-200 dark:border-gray-700 rounded-xl hover:shadow-lg transition-all duration-300 hover:border-purple-300 dark:hover:border-purple-700 group">
              ...
              <h4 className="font-medium text-gray-900 dark:text-white mb-3">Centre National</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
