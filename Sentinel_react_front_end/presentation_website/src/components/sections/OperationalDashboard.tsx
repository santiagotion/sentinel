...
export function OperationalDashboard() {
  return (
    <section id="operational-dashboard" className="py-24 bg-gray-900 dark:bg-gray-900 relative overflow-hidden">
      <VerticalLinePattern />
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 dark:from-gray-800 dark:to-gray-900 border border-gray-600 dark:border-gray-600 rounded-xl p-6 mb-8 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-white dark:text-white">État du Système</h3>
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-400">Opérationnel - Mise à jour automatique</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-medium text-white dark:text-white mb-1">2.3s</div>
              <div className="text-sm text-gray-600">Latence moyenne</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-medium text-white dark:text-white mb-1">99.97%</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 dark:from-gray-800 dark:to-gray-900 border border-gray-600 dark:border-gray-600 rounded-xl p-6 shadow-lg">
              {/* Alert Summary */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 border border-red-200 dark:border-red-700 rounded-xl p-4 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  ...
                  <div className="text-sm text-gray-300">Alertes Critiques</div>
                  <div className="text-xs text-gray-400 mt-1">Dernières 24h</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 border border-yellow-200 dark:border-yellow-700 rounded-xl p-4 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  ...
                  <div className="text-sm text-gray-300">En Surveillance</div>
                  <div className="text-xs text-gray-400 mt-1">Analyse en cours</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border border-green-200 dark:border-green-700 rounded-xl p-4 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  ...
                  <div className="text-sm text-gray-300">Résolues</div>
              ...
              {/* Recent Alerts */}
              <div>
                <h4 className="font-medium text-white dark:text-white mb-3">Alertes Récentes</h4>
                <div className="space-y-2">
                  <div className="flex items-center justify-between bg-gray-900 border border-red-700 rounded-lg p-3">
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                      <div>
                        <div className="text-sm font-medium text-gray-200">Campagne de désinformation - Secteur minier</div>
                        <div className="text-xs text-gray-400">Nord-Kivu • il y a 15 min</div>
                      </div>
                    </div>
                    <span className="text-xs bg-red-100 text-red-700 px-2 py-1 rounded">CRITIQUE</span>
                  </div>
                  
                  <div className="flex items-center justify-between bg-gray-900 border border-yellow-700 rounded-lg p-3">
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-yellow-500 rounded-full"></div>
                      <div>
                        <div className="text-sm font-medium text-gray-200">Réseau de comptes coordonnés détecté</div>
                        <div className="text-xs text-gray-400">Kinshasa • il y a 32 min</div>
                      </div>
                    </div>
                    <span className="text-xs bg-yellow-100 text-yellow-700 px-2 py-1 rounded">MOYEN</span>
                  </div>
                  
                  <div className="flex items-center justify-between bg-gray-900 border border-blue-700 rounded-lg p-3">
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                      <div>
                        <div className="text-sm font-medium text-gray-200">Pic d'activité anormal - Élections locales</div>
                        <div className="text-xs text-gray-400">Haut-Katanga • il y a 1h</div>
                      </div>
                    </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 dark:from-gray-800 dark:to-gray-900 border border-gray-600 dark:border-gray-600 rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-center space-x-3 mb-3">
                  <div className="w-10 h-10 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl flex items-center justify-center">
                    <Activity className="w-5 h-5 text-white" />
                  </div>
                  <h4 className="font-medium text-white dark:text-white">Traitement</h4>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Messages/seconde</span>
                    <span className="font-medium text-white dark:text-white">1,247</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Files d'attente</span>
                    <span className="font-medium text-white dark:text-white">0</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Charge CPU</span>
                    <span className="font-medium text-white dark:text-white">23%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 dark:from-gray-800 dark:to-gray-900 border border-gray-600 dark:border-gray-600 rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h4 className="font-medium text-white dark:text-white">Précision</h4>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Détection</span>
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-white dark:text-white">0.3%</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Confiance moy.</span>
                    <span className="font-medium text-white dark:text-white">94.2%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 dark:from-gray-800 dark:to-gray-900 border border-gray-600 dark:border-gray-600 rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h4 className="font-medium text-white dark:text-white">Couverture</h4>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Provinces</span>
                    <span className="font-medium text-white dark:text-white">26/26</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Langues</span>
                    <span className="font-medium text-white dark:text-white">15</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Plateformes</span>
                    <span className="font-medium text-white dark:text-white">8/8</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 dark:from-gray-800 dark:to-gray-900 border border-gray-600 dark:border-gray-600 rounded-xl p-6 shadow-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-gray-300">Mentions "sécurité"</span>
                <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-300">Sentiment négatif</span>
                <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-300">Comptes suspects</span>
                <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-300">Interventions réussies</span>
                <div className="flex items-center space-x-2">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">Analystes en ligne</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">Spécialistes sécurité</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">Superviseurs</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">Équipe d'intervention</span>
                </div>
        ...
        {/* Quick Actions */}
        <div className="bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-800 dark:to-neutral-900 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button className="bg-gray-900 dark:bg-gray-900 border border-gray-600 dark:border-gray-600 rounded-xl p-4 text-center hover:shadow-lg transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-700 group">
              ...
              <div className="text-sm font-medium text-gray-200">Rapport Détaillé</div>
            </button>
            <button className="bg-gray-900 dark:bg-gray-900 border border-gray-600 dark:border-gray-600 rounded-xl p-4 text-center hover:shadow-lg transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-700 group">
              ...
              <div className="text-sm font-medium text-gray-200">Créer Alerte</div>
            </button>
            <button className="bg-gray-900 dark:bg-gray-900 border border-gray-600 dark:border-gray-600 rounded-xl p-4 text-center hover:shadow-lg transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-700 group">
              ...
              <div className="text-sm font-medium text-gray-200">Assigner Équipe</div>
            </button>
            <button className="bg-gray-900 dark:bg-gray-900 border border-gray-600 dark:border-gray-600 rounded-xl p-4 text-center hover:shadow-lg transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-700 group">
              ...
              <div className="text-sm font-medium text-gray-200">Vue Géographique</div>
            </button>
          </div>
        </div>
      </div>
