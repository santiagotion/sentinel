        ...
        <div className="mb-12">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col justify-between items-center py-8">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="w-1 h-16 bg-gradient-to-b from-congo-blue to-congo-red opacity-50"></div>
              ))}
            </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                        {layer.components.map((component, compIndex) => (
                          <div key={compIndex} className="text-sm bg-gray-50 dark:bg-gray-700 rounded px-3 py-2">
                            {component}
                          </div>
                        ))}
                      </div>
