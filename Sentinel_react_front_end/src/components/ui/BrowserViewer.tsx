...
export function BrowserViewer({ isActive, searchQuery, screenshot, onVideoOpen }: BrowserViewerProps) {
  ...
  return (
    <motion.div
      ...
      className={`fixed right-6 top-20 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-50 ${
        isMinimized ? 'w-80' : 'w-[800px] h-[700px]'
      }`}
    >
      {/* Header */}
        ...
        <>
          ...
          <div className="p-3 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center space-x-2 bg-white dark:bg-gray-800 rounded-md px-3 py-2 border">
              ...
              <div className="flex-1 text-sm text-gray-600 dark:text-gray-400 truncate">
                {currentUrl || `https://www.youtube.com/results?search_query=${encodeURIComponent(searchQuery)}`}
              </div>
            </div>
          </div>
          ...
          {screenshot && (
            <div className="p-3 border-b border-gray-200 dark:border-gray-700">
              <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Live Browser View</h4>
              <div className="bg-gray-100 dark:bg-gray-900 rounded-lg overflow-hidden">
                <img 
                  src={screenshot} 
                  alt="Real browser automation"
